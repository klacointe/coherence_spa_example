...
defmodule CoherenceSpaWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: CoherenceSpaWeb.Coherence.EmailView, layout: {CoherenceSpaWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
