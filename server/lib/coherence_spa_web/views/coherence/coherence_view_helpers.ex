defmodule CoherenceSpaWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers CoherenceSpaWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CoherenceSpaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CoherenceSpaWeb.Gettext, "errors", msg, opts)
    end
  end
